    ...
    return (
        <tr className="bg-white border-b">
            ...
            <td className="py-4 px-6">
                ...
                <a href={shareTwitterUrl("I invite you to solve this questionnaire of only 10 questions", `${baseUrl}/questionnaire/resolved/${id}`)} target="_blank" type="button" className="text-white bg-gradient-to-r from-cyan-500 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-cyan-300 font-medium rounded-lg text-sm px-7 py-3.5 text-center mr-4 mb-2 inline-block">
                    Tweet
                </a>
            </td>
        </tr>
